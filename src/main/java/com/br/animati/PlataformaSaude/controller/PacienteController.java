...
import com.br.animati.PlataformaSaude.service.PacienteService;
...
public class PacienteController {
	...
	public Paciente findById(@PathVariable long idPaciente) {
		return pacienteService.listarPeloId(idPaciente).get();
	}
	...
	public void update(@PathVariable long idPaciente, @RequestBody Paciente newPaciente) {
		Optional<Paciente> oldPaciente = pacienteService.listarPeloId(idPaciente);
